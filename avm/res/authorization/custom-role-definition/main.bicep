metadata name = 'Role definition assignable scopes (All scopes)'
metadata description = 'This module deploys a Custom Role definition at a Management Group, Subscription or Resource Group scope.'
